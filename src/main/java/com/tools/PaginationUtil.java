...
public class PaginationUtil
{
  public static void main(String[] args)
  {
    //System.out.println(getPaginationHtml(Integer.valueOf(600), Integer.valueOf(30), Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(5), "/xxx/ddd/{page}/sss"));
  	 ...
  	 * @param link_to 链接
  	 * @param ishtml 链接是否是javascript链接，还是java链接
  	 * @return
  	 */
  public static String getPaginationHtml(Integer allTotal, Integer currentRows, Integer currentPage, Integer edgeEntries, Integer displayEntries, String link_to,boolean ishtml)
  {
    ...
    if (allTotal.intValue() > 0) {
      sb.append("<li class=\"total_page\">页数<i>" + currentPage + "/" + total + "</i>&nbsp;&nbsp;共<i>" + allTotal + "</i>条记录</li>");
    }
    if(ishtml){
