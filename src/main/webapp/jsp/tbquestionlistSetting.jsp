...
$(document).on('ready', function() {
 ...
 function showDataByURL(file_id,show_id) {
...
<input type="hidden" id="question_id" name="entity.question_id" value="${question_id}" />
				<tr>
					...
					<tr >
						...
						<td>
						<img id="img1" src=".${entity.question_img }" style="display: block;width:40px;height:30px"/>
						    <input type="hidden" id="question_img" name="entity.question_img"  value="${entity.question_img }"/>
